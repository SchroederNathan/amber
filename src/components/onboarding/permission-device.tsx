...
const devices = {
  camera: require('../../../assets/onboarding/device-camera.png'),
  photos: require('../../../assets/onboarding/device-photos.png'),
  biometrics: require('../../../assets/onboarding/device-biometrics.png'),
};
